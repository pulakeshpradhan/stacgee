...
Thank you for your help improving **stacgee**!

**stacgee** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **stacgee** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/stacgee
   cd stacgee
...
This will install the **stacgee** library, together with two additional tools:
